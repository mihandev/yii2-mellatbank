...
class MellatBank extends \yii\base\Widget {
    ...
    public function run() {
        ...
        echo Html::submitButton(isset($this->options['title']) ? $this->options['title'] : 'Å—œ«Œ ', ['class' => isset($this->options['buttonClass']) ? $this->options['buttonClass'] : 'btn btn-success']);
        ActiveForm::end();
    ...
    protected function getError($number)
    {
        ...
        switch ($number) {
            case 31     : $err = "Å«”Œ ‰«„⁄ »— «” !";                       break;
            case 17     : $err = "ò«—»— «“ «‰Ã«„  —«ò‰‘ „‰’—› ‘œÂ «” !";    break;
            case 21     : $err = "Å–?—‰œÂ ‰«„⁄ »— «” !";                    break;
            case 25     : $err = "„»·€ ‰«„⁄ »— «” !";                       break;
            case 34     : $err = "Œÿ«? ”?” „?!";                            break;
            case 41     : $err = "‘„«—Â œ—ŒÊ«”   ò—«—? «” !";               break;
            case 421    : $err = "«? Å? ‰«„⁄ »— «” !";                      break;
            case 412    : $err = "‘‰«”Â ﬁ»÷ ‰«œ—”  «” !";                   break;
            case 45     : $err = " —«ò‰‘ «“ ﬁ»· ” · ‘œÂ «” ";               break;
            case 46     : $err = " —«ò‰‘ ” · ‘œÂ «” ";                      break;
            case 35     : $err = " «—?Œ ‰«„⁄ »— «” ";                       break;
            case 32     : $err = "›—„  «ÿ·«⁄«  Ê«—œ ‘œÂ ’Õ?Õ ‰„?»«‘œ";       break;
            case 43     : $err = "œ—ŒÊ«”  verify ﬁ»·« ’«œ— ‘œÂ «” ";         break;
        }
